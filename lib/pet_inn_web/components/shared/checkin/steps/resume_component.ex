        ...
        <div class="w-full sm:w-[49%] mb-2">
          <.card>
            <.card_content category={gettext("Dados Pessoais")}>
              ...
              <span><strong>Nome Completo:</strong> <%= @user.name %></span> <br />
              <span><strong>Data de Nascimento:</strong> <%= @user.birthday %></span> <br />
              <span><strong>Gênero:</strong> <%= @user.gender %></span> <br />
              <span><strong>Profissão:</strong> <%= @user.job %></span> <br /><br /> <hr /> <br />
              <span><strong>CEP:</strong> <%= @user.address.code %></span> <br />
              <span><strong>País:</strong> <%= @user.address.country %></span> <br />
              <span><strong>Estado:</strong> <%= @user.address.state %></span> <br />
              <span><strong>Cidade:</strong> <%= @user.address.city %></span> <br />
              <span><strong>Bairro:</strong> <%= @user.address.neighborhood %></span> <br />
              <span><strong>Logradouro:</strong> <%= @user.address.street %></span> <br />
              <span><strong>Número:</strong> <%= @user.address.number %></span> <br />
        ...
        <div :for={pet <- @user.pets} class="w-full sm:w-[49%] mb-2">
          <.card>
            <.card_content category={gettext("Dados do Pet")}>
              <span><strong>Nome:</strong> <%= pet.name %></span> <br />
              <span><strong>Espécie:</strong> <%= pet.specie %></span> <br />
              <span><strong>Raça:</strong> <%= pet.race %></span> <br />
              <span><strong>Alimentação:</strong> Lista</span> <br />
              <span>
